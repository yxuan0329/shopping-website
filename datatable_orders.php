...
<script src="datatable_orders.js"></script>
<style>
body {
    font-family: "微軟正黑體";
}
                    ...
                    <thead>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" id="order_id" name="order_id" style="width:80px">
                            </td>
                            <td class="text-center">
                                <input type="text" id="mid" name="mid" style="width:100px">
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                <input type="text" id="address" name="address"style="width:80px">
                            </td>
                            <td class="text-center">
                                <input type="text" id="amount" name="amount" style="width:110px">
                            </td>
                            <td>
