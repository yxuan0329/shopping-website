...
<html>
<head>
<title>商品管理 | Little Things | Online Shopping Mall</title>
...
<script src="datatable_product.js"></script>
<style>
body {
    font-family: "微軟正黑體";
}
                    ...
                    <thead>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="text" id="good_id" name="good_id" style="width:80px">
                            </td>
                            <td class="text-center">
                                <input type="text" id="good_name" name="good_name" style="width:100px">
                            </td>
                            <td class="text-center">
                                <input type="text" id="category" name="category" style="width:100px">
                            </td>
                            <td class="text-center">
                                <input type="text" id="numbers" name="numbers" style="width:100px">
                            </td>
                            <td class="text-center">
                                <input type="text" id="price" name="price"style="width:80px">
                            </td>
                            <td class="text-center">
                                <input type="text" id="description" name="description" style="width:110px">
                            </td>
                            <td>
